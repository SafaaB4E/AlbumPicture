...
SWIFT_MODULE_NAMESPACE_PUSH("AlbumsMnager")
@class UIWindow;
@class UIApplication;

/// Le délégué de l’application fonctionne à côté de l’objet de l’application pour garantir que l’application interagit correctement avec le système et avec d’autres applications
SWIFT_CLASS("_TtC12AlbumsMnager11AppDelegate")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC12AlbumsMnager18CollectionViewCell")
@interface CollectionViewCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified CollectionViewCell;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC12AlbumsMnager18ImageUploadManager")
...
SWIFT_CLASS("_TtC12AlbumsMnager14ViewController")
@interface ViewController : UIViewController <SKPhotoBrowserDelegate>
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified showAlbumButton;
...
- (IBAction)doDeleteClick:(id _Nonnull)sender;
...
@interface ViewController (SWIFT_EXTENSION(AlbumsMnager))
/// didSelectItemAtIndexPath: L’action a faire si une photo dans la cellection est cliquer .
/// \param collectionView la collection laquelle qu’on veut personnaliser.
///
/// \param indexPath l’index de la celulle courante.
///
...
/// \param collectionView la collection laquelle qu’on veut personnaliser.
///
/// \param section la section qu’on veut configurer.
///
...
@interface ViewController (SWIFT_EXTENSION(AlbumsMnager)) <UICollectionViewDataSource, UICollectionViewDelegate>
@end
